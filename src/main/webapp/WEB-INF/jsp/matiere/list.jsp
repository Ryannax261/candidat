...
<body>
    <div class="container mt-5">
        <div class="header-container d-flex justify-content-between align-items-center">
            <h2 class="page-title mb-0">📚 Liste des Matières</h2>
            <a href="<%= request.getContextPath() %>/matieres/new" class="sunset-btn">➕ Ajouter une Matière</a>
        </div>
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td>
                                <a href="<%= request.getContextPath() %>/matieres/edit/<%= m.getId() %>" class="sunset-btn-warning btn-sm">✏️ Éditer</a>
                                <a href="<%= request.getContextPath() %>/matieres/delete/<%= m.getId() %>" class="sunset-btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette matière ?');">🗑️ Supprimer</a>
                            </td>
                        </tr>
                    <%
                            }
