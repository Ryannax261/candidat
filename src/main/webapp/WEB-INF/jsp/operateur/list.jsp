...
<body>
    <div class="container mt-5">
        <div class="header-container d-flex justify-content-between align-items-center">
            <h2 class="page-title mb-0">🔢 Liste des Opérateurs</h2>
            <a href="<%= request.getContextPath() %>/operateurs/new" class="sunset-btn">➕ Ajouter un Opérateur</a>
        </div>
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td>
                                <a href="<%= request.getContextPath() %>/operateurs/edit/<%= o.getId() %>" class="sunset-btn-warning btn-sm">✏️ Éditer</a>
                                <a href="<%= request.getContextPath() %>/operateurs/delete/<%= o.getId() %>" class="sunset-btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet opérateur ?');">🗑️ Supprimer</a>
                            </td>
                        </tr>
                    <%
                            }
