...
<body>
    <div class="container mt-5">
        <div class="header-container d-flex justify-content-between align-items-center">
            <h2 class="page-title mb-0">⚡ Liste des Résolutions</h2>
            <a href="<%= request.getContextPath() %>/resolutions/new" class="sunset-btn">➕ Ajouter une Résolution</a>
        </div>
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td><%= r.getNom() %></td>
                            <td>
                                <a href="<%= request.getContextPath() %>/resolutions/edit/<%= r.getId() %>" class="sunset-btn-warning btn-sm">✏️ Éditer</a>
                                <a href="<%= request.getContextPath() %>/resolutions/delete/<%= r.getId() %>" class="sunset-btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette résolution ?');">🗑️ Supprimer</a>
                            </td>
                        </tr>
                    <%
                            }
