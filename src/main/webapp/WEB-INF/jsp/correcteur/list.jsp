...
<body>
    <div class="container mt-5">
        <div class="header-container d-flex justify-content-between align-items-center">
            <h2 class="page-title mb-0">👨‍🏫 Liste des Correcteurs</h2>
            <a href="<%= request.getContextPath() %>/correcteurs/new" class="sunset-btn">➕ Ajouter un Correcteur</a>
        </div>
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td><%= c.getNumtel() %></td>
                            <td>
                                <a href="<%= request.getContextPath() %>/correcteurs/edit/<%= c.getId() %>" class="sunset-btn-warning btn-sm">✏️ Éditer</a>
                                <a href="<%= request.getContextPath() %>/correcteurs/delete/<%= c.getId() %>" class="sunset-btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce correcteur ?');">🗑️ Supprimer</a>
                            </td>
                        </tr>
                    <%
                            }
