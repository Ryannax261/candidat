...
<body>
    <div class="container mt-5">
        <div class="header-container d-flex justify-content-between align-items-center">
            <h2 class="page-title mb-0">⚙️ Liste des Paramètres</h2>
            <a href="<%= request.getContextPath() %>/parametres/new" class="sunset-btn">➕ Ajouter un Paramètre</a>
        </div>
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td><%= p.getSeuil() %></td>
                            <td>
                                <a href="<%= request.getContextPath() %>/parametres/edit/<%= p.getId() %>" class="sunset-btn-warning btn-sm">✏️ Éditer</a>
                                <a href="<%= request.getContextPath() %>/parametres/delete/<%= p.getId() %>" class="sunset-btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce paramètre ?');">🗑️ Supprimer</a>
                            </td>
                        </tr>
                    <%
                            }
